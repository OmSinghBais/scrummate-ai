                    ...
                    <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-neutral-400">Connect your Jira instance</p>
                        </div>
                        <div className="px-4 py-2 rounded-full bg-green-500/20 text-green-400 text-sm">
                          Connected
                        </div>
                      </div>
                      <button className="px-4 py-2 rounded-lg border border-white/20 text-white hover:bg-white/5 transition-colors">
                        Configure
                      </button>
                    </div>
                    ...
                    <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-neutral-400">Connect your GitHub repository</p>
                        </div>
                        <div className="px-4 py-2 rounded-full bg-green-500/20 text-green-400 text-sm">
                          Connected
                        </div>
